...
<template>
  <div class="contanier">
    ...
    <h3>其他相关demo及API可以参考ant-design</h3>
    <h1>共同的 API</h1>
    <a-table
      ...
      dataSource1: [
        {
          ...
          description: '可选，绑定值的格式，对 value、defaultValue、defaultPickerValue 起作用。不指定则绑定值为 dayjs 对象',
          type: 'string',
          default: '-'
        }
      ],
